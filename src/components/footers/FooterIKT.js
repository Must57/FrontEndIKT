...
const Link2 = tw.a`border-b-2 border-transparent text-white hocus:text-gray-300 hocus:border-gray-300 pb-1 transition duration-300 mx-4`;
...
const CopyrightText = tw.p`text-center mt-10 font-medium tracking-wide text-sm text-orange-400`
export default () => {
    return (
        <Container>
            <Content>
                <Row>
                    ...
                    <CopyrightText>
                        &copy; Copyright 2021, I Know Travel. All Rights Reserved.
                    </CopyrightText>
                </Row>
            </Content>
        </Container>
